...
sap.ui.define([
		...
		"MyFirstProject/MyFirstProject/model/formatter"
	], function (
		BaseController,
		JSONModel,
		History,
		...
		return BaseController.extend("MyFirstProject.MyFirstProject.controller.Object", {
			...
			_onBindingChange : function () {
				...
				this.addHistoryEntry({
					...
					intent: "#MyFirstProject-display&/zjblessons_base_Materials/" + sObjectId
				});
